---
title: "Practicing Exploratory Data Analysis in R"
output:
...
Here we have a set of values in x which is either 0 or a little less than that. We can't see if clearly in visualization so let's filter those data points and see them as a table. 
